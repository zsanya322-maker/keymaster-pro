...
# ---------------------------------------------------------------------------
# 2) Remove the obsolete numeric VirtualDesktop editor from the UI. The legacy
# schema/runtime variant remains readable for old profiles, but new editing uses
# Context Match + the real GUID returned by IVirtualDesktopManager.
# ---------------------------------------------------------------------------
...
s = s.replace(legacy_editor, '', 1)

# Keep only common process/title + mode/capture visible; rare fields are under
# a native details disclosure to preserve the compact 0.3 UI language.
